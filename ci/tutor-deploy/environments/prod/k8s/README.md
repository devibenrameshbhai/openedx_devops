...
This repository contains a set of GitHub actions workflows to deploy Tutor's Open edX onto our [Kubenetes (EKS) cluster](https://github.com/devibenrameshbhai/terraform-aws).
...
All the necessary dependencies need to be deployed prior to deploying an environment for the first time using the terraform stack in [this repo](https://github.com/devibenrameshbhai/terraform-aws) and [this repo](https://github.com/devibenrameshbhai/terraform-openedx).
...
These are the FQDNs of the LMS and CMS components of Open edX and the location of the custom image that we build [here](https://github.com/devibenrameshbhai/tutor-build).
